# This could be considered a fork of the Kakscript included in the
# [rep repo](https://github.com/eraserhd/rep).
#
# NOTE: This script depends on the `rep` client!

declare-option -hidden str rep_evaluate_output
declare-option -hidden str rep_namespace

# TODO: Refactor to use our improved version over in `clojure.kak`.
